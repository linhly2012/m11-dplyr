...
print(colnames(pulitzer, prefix = "col"))
...
pulitzer <- mutate(pulitzer, Pulitzer.Price.Change = Pulitzer.Prize.Winners.and.Finalists..2004.2014 -  Pulitzer.Prize.Winners.and.Finalists..1990.2003)

# What publication gained the most pulitzer prizes from 2004-2014?
# Be sure to use the pipe operator! 
publication.gained.2014 <- filter(pulitzer, max(Pulitzer.Prize.Winners.and.Finalists..2004.2014) == 
